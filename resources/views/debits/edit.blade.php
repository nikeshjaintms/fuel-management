        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="nav-item"><a href="{{ route('admin.debits.index') }}">Debits</a></li>
                    <li class="separator"><i class="icon-arrow-right"></i></li>
                    <li class="nav-item"><a href="#">Debits</a></li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Edit Debit Note</div>
                        </div>
                        <form method="POST" action="{{ route('admin.debits.update', $debits->id) }}" id="creditForm">
                            @csrf
                            @method('PUT')
                            @if ($errors->any())
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="customer_name"
                                                id="customer_name" value="{{ $debits->customer_name }} GST:{{ $debits->customer_gst }}" readonly />
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group">
                                            <label for="invoice_id">Invoice No<span style="color: red">*</span></label>
                                           <input type="text" name="invoice_no" id="invoice_no" class="form-control" value="{{ $debits->invoice_no }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="debit_number">Debit no<span style="color: red">*</span></label>
                                            <input type="text" class="form-control" name="debit_number"
                                                id="debit_number" value="{{ $debits->debit_number }}" readonly required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="debit_date">Debit Date<span style="color: red">*</span></label>
                                            <input type="date" class="form-control" readonly value="{{ $debits->debit_date }}" name="credit_date" id="credit_date"
                                                required />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <table id="vehicle-table" class="display table table-striped-rows table-hover">
                                                ...
                                                <tbody id="vehicle-body">
                                                    @foreach ($debits_items as $key => $ci)
                                                    <tr>
                                                        <td>1</td>
                                                        <td>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" readonly value="{{ $debits->subtotal_amount }}"  class="form-control" name="subtotal_amount"
                                                id="subtotal_amount" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="tax_type" id="tax_type" class="form-control" required>
                                                ...
                                                <option {{ $debits->tax_type == 'cgst/sgst' ? "selected" : "" }} value="cgst/sgst">CGST/SGST</option>
                                                <option {{ $debits->tax_type == 'igst' ? "selected" : "" }} value="igst">IGST</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" value="{{ $debits->tax }}" name="tax" id="tax"
                                                required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" readonly class="form-control" value="{{ $debits->tax_amount }}" name="tax_amount"
                                                id="tax_amount" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" readonly class="form-control" value="{{ $debits->total_amount }}" name="total_amount"
                                                id="total_amount" />
                                        </div>
                                    </div>
                                </div>
