                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Add Debit Note</div>
                        </div>
                        <form method="POST" action="{{ route('admin.debits.store') }}" id="creditForm">
                            @csrf
                            @if ($errors->any())
        ...
        $(document).ready(function() {
            ...
            $("#creditForm").validate({
                ...
                messages: {
                    ...
                    debit_number: {
                        required: "Debit number is required."
                    },
                    debit_date: {
                        required: "Debit date is required.",
