                            ...
                            if (response.vehicles.length > 0) {
                                $.each(response.vehicles, function(index, vehicle) {
                                    var newRow = `<tr class="vehicle-row">
                                        ...
                                        <td><input type="number" readonly name="min_km[]" class="form-control min_km" value="${vehicle.min_km}" required></td>
                                        <td><input type="text" readonly name="rate[]" class="form-control rate" value="${vehicle.rate}" required></td>
                                        <td><input type="text" readonly name="extra_km_rate[]" class="form-control extra-km-rate" value="${vehicle.extra_km_rate}" required></td>
                                        <td><input type="number" readonly name="extra_km_drive[]" class="form-control extra_km_drive" required></td>
                                        <td><input type="number" name="km_drive[]" class="form-control" required></td>
                                        <td><input type="number" readonly name="total_extra_km_amount[]" class="form-control total_extra_km_amount" required></td>
                                        <td><input type="text" readonly name="rate_per_hour[]" class="form-control rate_per_hour" value="${vehicle.rate_per_hour}" required></td>
                                        <td><input type="number" name="overtime[]" class="form-control overtime"></td>
                                        <td><input type="number" readonly name="overtime_amount[]" class="form-control overtime_amount" required></td>
                                    </tr>`;
