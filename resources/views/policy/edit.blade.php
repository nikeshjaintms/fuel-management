                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Edit Insurance Policy Details </div>
                        </div>
                        <form method="POST" action="{{ route('admin.policy.update', $rto->id ) }}" id="vehicleForm" >
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="{{ $rto->expiry_date }}" name="expiry_date" id="expiry_date"  required />
                                        </div>
                                    </div>
                                </div>
                            </div>
