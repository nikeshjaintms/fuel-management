                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" value="{{ $data->pending_emi ?? NULL }}" name="pending_emi" id="pending_emi" placeholder="Enter a Total EMI " />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="installment_date" id="" class="form-control">
                                                ...
                                                @foreach(range(1, 28) as $day)
                                                    <option
                                                    {{ $installment->installment_date == $day ? ' selected' : '' }}
