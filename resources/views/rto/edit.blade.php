                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Edit RTO Details </div>
                        </div>
                        <form method="POST" action="{{ route('admin.rto.update', $rto->id ) }}" id="vehicleForm" >
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="vehicle_id" id="vehicle_id" class="form-control">
                                                ...
                                                @foreach($vehicles as $vehicle)
                                                    ...
                                                    <option {{ $rto->vehicle_id == $vehicle->id ? 'selected' : '' }} value="{{$vehicle->id }}">{{ $vehicle->vehicle_no }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="policy_no" value="{{ $rto->policy_no }}" id="policy_no" placeholder="Enter a Policy no" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="{{ $rto->policy_expiry_date }}" name="policy_expiry_date" id="policy_expiry_date"  required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="fitness_expiry_date">Fitness Expiry Date<span style="color: red">*</span></label>
                                            <input type="date" class="form-control" value="{{ $rto->fitness_expiry_date }}" name="fitness_expiry_date" id="fitness_expiry_date"  required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="puc_expiry_date">PUC Expiry Date<span style="color: red">*</span></label>
                                            <input type="date" class="form-control" value="{{$rto->puc_expiry_date }}" name="puc_expiry_date" id="puc_expiry_date"  required />
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        $("#vehicleForm").validate({
            ...
            messages: {
                ...
                policy_no: {
                    ...
                    minlength: "Policy number should be at least 5 characters long.",
