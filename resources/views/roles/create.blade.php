                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            @foreach ($permissions as $permission)
                                                <label for=""><input class="permission-checkbox" type="checkbox"
...
@section('footer-script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $.validator.addMethod("permissionsRequired", function(value, element) {
            ...
            $("#roleForm").validate({
                ...
                submitHandler: function(form) {
                    if ($('.permission-checkbox:checked').length === 0) {
                        ...
                        $('#permissions-error').text(""); // Clear any previous error
                        form.submit();
                    }
                }
            });
