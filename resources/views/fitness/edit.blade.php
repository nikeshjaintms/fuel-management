                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Edit Fitness Details </div>
                        </div>
                        <form method="POST" action="{{ route('admin.fitness.update', $rto->id ) }}" id="vehicleForm" >
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="expiry_date">Fitness Expiry Date<span style="color: red">*</span></label>
                            ...
                            <div class="card-action">
                                ...
                                <a href="{{ route('admin.fitness.index')}}" class="btn btn-danger" >Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
...
$(document).ready(function () {
    $("#vehicle_id").change(function () {
        ...
        if (vehicleId) {
            $.ajax({
                url: "{{ route('admin.fitness.checkVehicle') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
